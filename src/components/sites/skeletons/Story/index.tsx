export default function Story({ data, template_id, setContext }: any) {
  return (
    <div>
      <div id="wrapper" className="divided">
        <section className="banner style1 orient-left content-align-left image-position-right fullscreen onload-image-fade-in onload-content-fade-right">
          ...
          <div className="image">
            <img
              src="https://wallpapers.com/images/featured/new-york-city-5oaa14h4mw6w3o71.jpg"
              alt=""
            />
          </div>
        </section>
        ...
        <footer className="wrapper style1 align-center">
          <div className="inner">
            <p>
              &copy; Made by <a href="https://www.legis.live">Legis</a>.
            </p>
          </div>
        </footer>
      </div>
