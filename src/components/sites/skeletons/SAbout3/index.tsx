...
export default function SAbout3({data} : any) {
    ...
    <div className={i("wrapper")}>
      ...
      >
        <div>
          <img className={i("image")} style={{ ...s?.image }}src={`${data?.cdnUUID ? getUrl(data?.cdnUUID) : 'https://upload.wikimedia.org/wikipedia/commons/thumb/2/2f/Gray_Wikipedia_Logo.jpg/715px-Gray_Wikipedia_Logo.jpg?20191209222645'}`} alt="About Us" />
        </div>
