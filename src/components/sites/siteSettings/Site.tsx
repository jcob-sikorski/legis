...
function SiteComponent() {
  ...
  const [siteFaviconURL, setSiteFaviconURL] = useState<string>(
    site?.favicon_url || ""
  );
  ...
  async function beforeUpload(file: any) {
    ...
    const isJpgOrPng =
      file.type === "image/x-icon" || file.type === "image/png";
    if (!isJpgOrPng) {
      ...
      <Layout style={{ overflowY: "scroll" }}>
        ...
        >
          ...
          <Title
            ...
            style={{ fontWeight: "normal", color: "#616161", marginBottom: 30 }}
          >
            A brief description of this site (and what’s usually used in
            bookmarks, search engine listings, etc.)
          </Title>
