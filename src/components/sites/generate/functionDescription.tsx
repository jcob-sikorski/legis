          ...
          PracticeAreas: {
            ...
            items: {
              ...
              properties: {
                ...
                practiceDescription: {
                  description:
                    "Short description of a practice area, easy to understand and professional",
                  type: "string",
                },
              },
            },
          ...
          OurTeam: {
            ...
            items: {
              ...
              properties: {
                ...
                description: {
                  description:
                    "Short description of the team member, easy to understand and professional",
                  type: "string",
                },
              },
            },
          ...
          OurValues: {
            ...
            items: {
              ...
              properties: {
                ...
                description: {
                  description:
                    "Short description of the value, easy to understand and professional - don’t mention the full name of the value",
                  type: "string",
                },
              },
            },
