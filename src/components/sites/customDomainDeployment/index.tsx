...
function CustomDomainDeployment() {
  ...
  useEffect(() => {
    const checkSubscription = async () => {
      ...
      const { data } = await axios.get(`${import.meta.env.DEV ? "http://localhost:4242" : "https://legis-cors-anywhere-xmo76.ondigitalocean.app/https://app.legis.live"}/check-subscription`, {
        params: { email: email }
      });
