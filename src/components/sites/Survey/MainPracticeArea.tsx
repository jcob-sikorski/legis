...
export function MainPracticeArea({
  page,
  fields,
  fieldValues,
  updateField,
  ...
  return (
    <div>
      <div style={{ fontSize: "30px", fontWeight: "bolder" }}>
        What is your main practice area? (e.g., Family Law)
      </div>
      <div className="custom-select">
        <Select
          placeholder="Select your main practice area"
          value={
            fieldValues?.MainPracticeArea
              ? fieldValues?.MainPracticeArea.toString()
              : ""
          }
          onChange={(value: string) =>
            updateField(fields[page] as keyof Questionnaire, value)
          }
          style={{
            width: "100%",
            marginTop: "10px",
        ...
        >
          <Option value="Banking and Debt finance Law">
          ...
          <Option value="Energy & Infrastructure Law">
          ...
          <Option value="Restructuring & insolvency law">
