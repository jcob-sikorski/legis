...
function Visualisation({
  ...
  variables?: any;
  mode?: string;
  template_set_id?: TemplateSetName;
}) {
  const {
    onAddSection,
    checkIfNoSections,
  ...
  function switchTemplate(data: any) {
    ...
    switch (template_set_id) {
      ...
      case "Hyperspace": {
        ...
        if (contains(template_id, "practice"))
          return (
            <Hyperspace
              template_id={template_id}
              data={data}
        ...
        if (contains(template_id, "values"))
          return (
            <Hyperspace
              template_id={template_id}
              data={data}
        ...
        if (contains(template_id, "reviews"))
          return (
            <Hyperspace
              template_id={template_id}
              data={data}
        ...
        if (contains(template_id, "contact"))
          return (
            <Hyperspace
              template_id={template_id}
              data={data}
        ...
        if (contains(template_id, "footer"))
          return (
            <Hyperspace
              template_id={template_id}
              data={data}
