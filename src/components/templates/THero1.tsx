...
function THero1({data} : any) {
    ...
    <div
      ...
      <div className="flex h-full justify-start items-center">
        <div className="flex-row justify-center align-center px-6 text-start text-white md:px-12">
            {/* <h3 className="text-lg mb-6">
                {data?.superHeading ?? 'ON-DEMAND WEBCAST'}
            </h3> */}
            <h2 className="text-4xl font-normal custom-font mb-4 tracking-tight md:text-5xl xl:text-6xl">
