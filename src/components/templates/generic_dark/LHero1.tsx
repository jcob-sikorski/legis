...
export function LHero1({
  ...
  return (
    <div id="home" style={{ fontFamily: "var(--legis-font-main)" }}>
      <div className="py-4 bg-black sm:py-6" x-data="{expanded: false}">
        <div className="px-4 mx-auto max-w-7xlx sm:px-6 lg:px-8">
          {/* NavBar */}
          <div
            className="flex flex-col sm:flex-row items-center justify-between bg-black"
            style={isDeploying ? {} : {}}
          >
                ...
                {data?.logo_cdnUUID ? (
                  <img
                    onClick={() =>
                      setContext({
                        key: "logo_cdnUUID",
                        inputSize: [120 * 2, 50 * 2],
                        cdnUUID: data?.logo_cdnUUID,
                        type: "image",
                    ...
                    src={
                      data?.logo_cdnUUID ? getUrl(data?.logo_cdnUUID) : "___"
                    }
            ...
            <div className="relative sm:inline-flex md:items-center md:justify-center md:inline-flex group">
              ...
              <a
                href="#contact-us"
                title=""
                className="relative inline-flex items-center justify-center px-6 py-2 text-base font-normalx text-black font-black bg-blackx border border-transparent rounded-full"
                style={{ minWidth: 150 }}
                role="button"
              >
                Contact Us
      ...
      >
        ...
        <div className="absolute top-0 right-0 bottom-0 left-0 h-full w-full overflow-hidden bg-[hsla(0,0%,0%,0.75)] bg-fixed">
          <div className="px-4 mx-auto relativea h-full sm:px-6 lg:px-8 max-w-7xl">
            <div
              className="flex justify-centerx h-full items-center"
              style={{ justifyContent: data?.blockVariant || "center" }}
            >
              <div
                className="flex bg-yellow-500x flex-col"
                style={{ width: "60vw" }}
              >
                <h1
