   ...
   <div className="px-6 mx-auto sm:px-8 lg:px-12 max-w-7xl">
       <div className="text-center">
           <h2 className="tracking-tighter text-white">
               <span className="font-sans text-4xl font-normal sm:text-5xl md:text-6xl"> See what </span>
               <span className="block font-serif text-5xl italic sm:inline sm:text-6xl md:text-7xl"> our clients </span>
               <span className="block font-sans text-4xl font-normal sm:inline sm:text-5xl md:text-6xl"> are saying. </span>
           </h2>
       </div>
