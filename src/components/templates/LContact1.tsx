...
export default function LContact1({data} : any) {
        ...
        <svg className="blur-3xl filter" style={{filter: "blur(64px)"}} width="643" height="408" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <defs>
                <linearGradient id="c" x1="663.766" y1="168.785" x2="303.65" y2="469.667" gradientUnits="userSpaceOnUse">
                    ...
                    <stop offset="100%" style={{stopColor: "var(--legis-color-2)"}} />
                </linearGradient>
            </defs>
        </svg>
    </div>
    ...
    <div className="relative px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        ...
        <div className="grid max-w-md grid-cols-1 mx-auto mt-8 overflow-hidden text-center bg-black border border-gray-900 bg-opacity-80 md:text-left sm:mt-12 lg:mt-16 md:grid-cols-3 rounded-xl filter backdrop-blur-lg md:max-w-none md:mx-0">
            <div className="">
                <div className="p-8 lg:p-12 xl:p-16">
                    <svg className="w-12 h-12 mx-auto md:mx-0" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1" xmlns="http://www.w3.org/2000/svg">
                        <path d="M3 8L10.8906 13.2604C11.5624 13.7083 12.4376 13.7083 13.1094 13.2604L21 8M5 19H19C20.1046 19 21 18.1046 21 17V7C21 5.89543 20.1046 5 19 5H5C3.89543 5 3 5.89543 3 7V17C3 18.1046 3.89543 19 5 19Z" stroke="url(#c31)" stroke-linecap="round" stroke-linejoin="round" />
                        <defs>
                            <linearGradient id="c31" x1="3" y1="5" x2="22.9157" y2="8.70639" gradientUnits="userSpaceOnUse">
                                <stop offset="0%" style={{stopColor: "var(--legis-color-1)"}} />
                                <stop offset="100%" style={{stopColor: "var(--legis-color-2)"}} />
                            </linearGradient>
                        </defs>
                    </svg>
                    <p className="mt-8 text-xl font-normal text-white lg:mt-12 lg:text-2xl">Email Address</p>
            ...
            <div className="border-t border-gray-900 md:border-l md:border-t-0">
                <div className="p-8 lg:p-12 xl:p-16">
                    <svg className="w-12 h-12 mx-auto md:mx-0" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1" xmlns="http://www.w3.org/2000/svg">
                        ...
                        />
                        <defs>
                            <linearGradient id="c32" x1="3" y1="3" x2="23.1826" y2="5.92138" gradientUnits="userSpaceOnUse">
                                <stop offset="0%" style={{stopColor: "var(--legis-color-1)"}} />
                                <stop offset="100%" style={{stopColor: "var(--legis-color-2)"}} />
                            </linearGradient>
                        </defs>
                    ...
                    <p className="mt-8 text-xl font-normal text-white lg:mt-12 lg:text-2xl">Call Us</p>
                    <p className="mt-5 text-base font-normal">
                ...
                <div className="p-8 lg:p-12 xl:p-16">
                    <svg className="w-12 h-12 mx-auto md:mx-0" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1" xmlns="http://www.w3.org/2000/svg">
                        <path
                            ...
                            stroke-linejoin="round"
                        />
                        <path d="M15 11C15 12.6569 13.6569 14 12 14C10.3431 14 9 12.6569 9 11C9 9.34315 10.3431 8 12 8C13.6569 8 15 9.34315 15 11Z" stroke="url(#c34)" stroke-linecap="round" stroke-linejoin="round" />
                        <defs>
                            <linearGradient id="c33" x1="4" y1="3" x2="22.0563" y2="5.16519" gradientUnits="userSpaceOnUse">
                                <stop offset="0%" style={{stopColor: "var(--legis-color-1)"}} />
                                <stop offset="100%" style={{stopColor: "var(--legis-color-2)"}} />
                            </linearGradient>
                            <linearGradient id="c34" x1="4" y1="3" x2="22.0563" y2="5.16519" gradientUnits="userSpaceOnUse">
                                <stop offset="0%" style={{stopColor: "var(--legis-color-1)"}} />
                                <stop offset="100%" style={{stopColor: "var(--legis-color-2)"}} />
                            </linearGradient>
                        </defs>
                    ...
                    <p className="mt-5 text-base font-normal">
                        <a href="#" title="" className="text-gray-400 hover:text-white">{data?.addressLine1 ?? "Address Line 1"}<br />{data?.addressLine2 ?? "Address Line 2"}</a>
                    </p>
                </div>
            </div>
        </div>
